...
export default function App() {
  ...
  return <div className="app-shell">
    <header className="topbar"><div><span className="brand-kicker">WRESTLING SIM</span><h1>TEW IX Story Tracker</h1></div><div className="phase-badge">PHASE 4C4 · GENERATED OUTPUTS</div></header>
    ...
    <footer>TEW remains the game. This companion stores creative plans, Match Stories, Segment Outputs, match approaches, optional advisory performance previews, editable generated narratives, handoff versions, histories, storylines, workers, championships, and rankings. TEW snapshot access remains read-only.</footer>
  </div>;
}
