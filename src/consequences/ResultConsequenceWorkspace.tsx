...
export default function ResultConsequenceWorkspace({ onOpenLiveCard, onOpenPlanner }: ResultConsequenceWorkspaceProps) {
  ...
  return <section className="consequence-workspace">
    <header className="consequence-hero"><div><p className="eyebrow">PHASE 6B3 · RESULT CONSEQUENCES</p><h2>Make the official result matter without letting the game invent what you book next</h2><p>Apply an Accepted or Overridden Wrestling Sim result once. Records, rankings, momentum, condition, and history update immediately. Championships, competitions, and future booking changes remain explicit decisions.</p></div><div className="consequence-principle"><span>Authority chain</span><strong>Result → Consequence → Creative Response</strong><small>Automatic records are idempotent. Permanent title and competition changes require confirmation.</small></div></header>
